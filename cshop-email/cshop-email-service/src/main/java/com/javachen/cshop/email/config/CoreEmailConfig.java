...
public class CoreEmailConfig {
    ...
    public EmailInfo changePasswordEmailInfo() {
        ...
        info.setTemplate("changePassword-com.javachen.cshop.email");
        return info;
    }
    ...
    public EmailInfo resetPasswordEmailInfo() {
        ...
        info.setTemplate("resetPassword-com.javachen.cshop.email");
        return info;
    }
    ...
    public EmailInfo registrationEmailInfo() {
        ...
        info.setTemplate("register-com.javachen.cshop.email");
        return info;
    }
}
