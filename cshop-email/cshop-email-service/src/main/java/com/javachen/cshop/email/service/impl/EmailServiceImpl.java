...
public class EmailServiceImpl implements EmailService {
    ...
    public void receive(Message<String> message) {
        ...
        try {
            ...
            log.info("Sending com.javachen.cshop.email success,from={},to={}", emailInfo.getFromAddress(), emailTo);
        } catch (Exception e) {
            log.error("Sending com.javachen.cshop.email fail,from={},to={}", emailInfo.getFromAddress(), emailTo, e);
        }
    }
