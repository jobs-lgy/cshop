...
public class ElasticsearchTest {
    ...
    public void createIndex(){
        // 创建索引
        this.elasticsearchTemplate.createIndex(com.javachen.domain.Item.class);
        // 配置映射
        this.elasticsearchTemplate.putMapping(com.javachen.domain.Item.class);
    }
    ...
    public void loadData() throws IOException {
        ...
        //创建Goods集合
        List<com.javachen.domain.Item> goodsList = new ArrayList<>();
        //遍历spu
        for (SpuBo spu : list) {
            try {
                System.out.println("spu id" + spu.getId());
                com.javachen.domain.Item goods = this.searchService.buildItem(spu);
                goodsList.add(goods);
            } catch (IOException e) {
    ...
    public void testAgg(){
        ...
        Page<com.javachen.domain.Item> goodsPage = this.goodsRepository.search(queryBuilder.build());
