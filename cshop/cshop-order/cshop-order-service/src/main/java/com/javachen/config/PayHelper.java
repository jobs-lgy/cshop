...
import com.javachen.config.PayConfig;
import com.javachen.service.OrderStatusService;
import com.javachen.utils.PayState;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        String key = "cshop.pay.url." + orderId;
        try {
    ...
    public PayState queryOrder(Long orderId) {
        ...
        try {
            ...
            if ("SUCCESS".equals(state)) {
                ...
                // 修改订单状态
                this.orderStatusService.updateStatus(orderId, 2);
