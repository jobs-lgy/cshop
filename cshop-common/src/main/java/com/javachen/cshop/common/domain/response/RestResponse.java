...
public class RestResponse<T> implements Serializable {
    ...
    public static RestResponse error(BusinessException businessException){
        return error(businessException);
    }

    public static RestResponse error(BusinessException businessException, String message){
        return error(businessException,message);
    }
