...
public class RestResponse<T> implements Serializable {
    ...
    public static RestResponse fail(BusinessException businessException){
        return fail(businessException);
    }

    public static RestResponse fail(BusinessException businessException,String message){
        return fail(businessException,message);
    }

    public static RestResponse fail(ErrorCodeAware errorCodeAware){
        return new RestResponse(errorCodeAware);
    }

    public static RestResponse fail(ErrorCodeAware errorCodeAware,String message){
