...
--   `history_integration` int(11) DEFAULT NULL COMMENT '历史积分数量',
  ...
  `enabled` int(1) DEFAULT NULL COMMENT '帐号启用状态:0->禁用；1->启用',
...
('1', '1', 'test','测试用户',  '{bcrypt}$2a$10$cKF9DpPPRn9oBfEU4caNHuM3N8hMaz/aI2Q4iuH.JZzhTCXlsviVi', '17602538617', 'junecloud@163.com', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 1,null,null,null,null,null,null,1,null,null,null );
...
DROP TABLE IF EXISTS `member_category_rel`;
...
CREATE TABLE `receive_address` (
  ...
  `default` int(1) DEFAULT NULL COMMENT '是否为默认',
...
CREATE TABLE `member_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员积分规则表';
